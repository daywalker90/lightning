...
#[allow(unused_variables, deprecated)]
impl From<responses::ListclosedchannelsClosedchannelsAlias>
    for pb::ListclosedchannelsClosedchannelsAlias
{
...
impl From<responses::DecodepayResponse> for pb::DecodepayResponse {
    fn from(c: responses::DecodepayResponse) -> Self {
        Self {
            ...
            amount_msat: c.amount_msat.map(|f| f.into()), // Rule #2 for type msat?
            payment_hash: c.payment_hash.to_vec(),        // Rule #2 for type hash
            signature: c.signature.into(),                // Rule #2 for type signature
            description: c.description,                   // Rule #2 for type string?
...
impl From<responses::DecodeResponse> for pb::DecodeResponse {
    fn from(c: responses::DecodeResponse) -> Self {
        Self {
            ...
            warning_missing_invoice_recurrence_basetime: c
                .warning_missing_invoice_recurrence_basetime, // Rule #2 for type string?
