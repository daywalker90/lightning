...
impl Node for Server {
    async fn getinfo(
        ...
        let result = rpc.call(Request::Getinfo(req)).await.map_err(|e| {
            Status::new(
                Code::Unknown,
        ...
        match result {
            ...
            r => Err(Status::new(
                Code::Internal,
                format!("Unexpected result {:?} to method call Getinfo", r),
            )),
        }
    }
    ...
    async fn list_peers(
        ...
        let mut rpc = ClnRpc::new(&self.rpc_path)
            .await
            .map_err(|e| Status::new(Code::Internal, e.to_string()))?;
        let result = rpc.call(Request::ListPeers(req)).await.map_err(|e| {
            Status::new(
                Code::Unknown,
        ...
        match result {
            ...
            r => Err(Status::new(
                Code::Internal,
                format!("Unexpected result {:?} to method call ListPeers", r),
            )),
        }
    }
    ...
    async fn list_funds(
        ...
        let mut rpc = ClnRpc::new(&self.rpc_path)
            .await
            .map_err(|e| Status::new(Code::Internal, e.to_string()))?;
        let result = rpc.call(Request::ListFunds(req)).await.map_err(|e| {
            Status::new(
                Code::Unknown,
        ...
        match result {
            ...
            r => Err(Status::new(
                Code::Internal,
                format!("Unexpected result {:?} to method call ListFunds", r),
            )),
        }
    }
    ...
    async fn send_pay(
        ...
        let mut rpc = ClnRpc::new(&self.rpc_path)
            .await
            .map_err(|e| Status::new(Code::Internal, e.to_string()))?;
        let result = rpc.call(Request::SendPay(req)).await.map_err(|e| {
            Status::new(
                Code::Unknown,
        ...
        match result {
            ...
            r => Err(Status::new(
                Code::Internal,
                format!("Unexpected result {:?} to method call SendPay", r),
            )),
        }
    }
    ...
    async fn list_channels(
        ...
        let mut rpc = ClnRpc::new(&self.rpc_path)
            .await
            .map_err(|e| Status::new(Code::Internal, e.to_string()))?;
        let result = rpc.call(Request::ListChannels(req)).await.map_err(|e| {
            Status::new(
                Code::Unknown,
        ...
        match result {
            ...
            r => Err(Status::new(
                Code::Internal,
                format!("Unexpected result {:?} to method call ListChannels", r),
            )),
        }
    }
    ...
    async fn add_gossip(
        ...
        let mut rpc = ClnRpc::new(&self.rpc_path)
            .await
            .map_err(|e| Status::new(Code::Internal, e.to_string()))?;
        let result = rpc.call(Request::AddGossip(req)).await.map_err(|e| {
            Status::new(
                Code::Unknown,
        ...
        match result {
            ...
            r => Err(Status::new(
                Code::Internal,
                format!("Unexpected result {:?} to method call AddGossip", r),
            )),
        }
    }
    ...
    async fn auto_clean_invoice(
        ...
        let mut rpc = ClnRpc::new(&self.rpc_path)
            ...
            .map_err(|e| Status::new(Code::Internal, e.to_string()))?;
        let result = rpc
            .call(Request::AutoCleanInvoice(req))
            .await
            .map_err(|e| {
                Status::new(
                    Code::Unknown,
        ...
        match result {
            ...
            r => Err(Status::new(
                Code::Internal,
                format!("Unexpected result {:?} to method call AutoCleanInvoice", r),
            )),
        }
    }
    ...
    async fn check_message(
        ...
        let mut rpc = ClnRpc::new(&self.rpc_path)
            .await
            .map_err(|e| Status::new(Code::Internal, e.to_string()))?;
        let result = rpc.call(Request::CheckMessage(req)).await.map_err(|e| {
            Status::new(
                Code::Unknown,
        ...
        match result {
            ...
            r => Err(Status::new(
                Code::Internal,
                format!("Unexpected result {:?} to method call CheckMessage", r),
            )),
        }
    }
    ...
    async fn close(
        ...
        let mut rpc = ClnRpc::new(&self.rpc_path)
            .await
            .map_err(|e| Status::new(Code::Internal, e.to_string()))?;
        let result = rpc.call(Request::Close(req)).await.map_err(|e| {
            Status::new(
                Code::Unknown,
        ...
        match result {
            ...
            r => Err(Status::new(
                Code::Internal,
                format!("Unexpected result {:?} to method call Close", r),
            )),
        }
    }
    ...
    async fn connect_peer(
        ...
        let mut rpc = ClnRpc::new(&self.rpc_path)
            .await
            .map_err(|e| Status::new(Code::Internal, e.to_string()))?;
        let result = rpc.call(Request::Connect(req)).await.map_err(|e| {
            Status::new(
                Code::Unknown,
        ...
        match result {
            ...
            r => Err(Status::new(
                Code::Internal,
                format!("Unexpected result {:?} to method call Connect", r),
            )),
        }
    }
    ...
    async fn create_invoice(
        ...
        let mut rpc = ClnRpc::new(&self.rpc_path)
            .await
            .map_err(|e| Status::new(Code::Internal, e.to_string()))?;
        let result = rpc.call(Request::CreateInvoice(req)).await.map_err(|e| {
            Status::new(
                Code::Unknown,
        ...
        match result {
            ...
            r => Err(Status::new(
                Code::Internal,
                format!("Unexpected result {:?} to method call CreateInvoice", r),
            )),
        }
    }
    ...
    async fn datastore(
        ...
        let mut rpc = ClnRpc::new(&self.rpc_path)
            .await
            .map_err(|e| Status::new(Code::Internal, e.to_string()))?;
        let result = rpc.call(Request::Datastore(req)).await.map_err(|e| {
            Status::new(
                Code::Unknown,
        ...
        match result {
            ...
            r => Err(Status::new(
                Code::Internal,
                format!("Unexpected result {:?} to method call Datastore", r),
            )),
        }
    }
    ...
    async fn create_onion(
        ...
        let mut rpc = ClnRpc::new(&self.rpc_path)
            .await
            .map_err(|e| Status::new(Code::Internal, e.to_string()))?;
        let result = rpc.call(Request::CreateOnion(req)).await.map_err(|e| {
            Status::new(
                Code::Unknown,
        ...
        match result {
            ...
            r => Err(Status::new(
                Code::Internal,
                format!("Unexpected result {:?} to method call CreateOnion", r),
            )),
        }
    }
    ...
    async fn del_datastore(
        ...
        let mut rpc = ClnRpc::new(&self.rpc_path)
            .await
            .map_err(|e| Status::new(Code::Internal, e.to_string()))?;
        let result = rpc.call(Request::DelDatastore(req)).await.map_err(|e| {
            Status::new(
                Code::Unknown,
        ...
        match result {
            ...
            r => Err(Status::new(
                Code::Internal,
                format!("Unexpected result {:?} to method call DelDatastore", r),
            )),
        }
    }
    ...
    async fn del_expired_invoice(
        ...
        let mut rpc = ClnRpc::new(&self.rpc_path)
            ...
            .map_err(|e| Status::new(Code::Internal, e.to_string()))?;
        let result = rpc
            .call(Request::DelExpiredInvoice(req))
            .await
            .map_err(|e| {
                Status::new(
                    Code::Unknown,
        ...
        match result {
            ...
            r => Err(Status::new(
                Code::Internal,
                format!("Unexpected result {:?} to method call DelExpiredInvoice", r),
            )),
        }
    }
    ...
    async fn del_invoice(
        ...
        let mut rpc = ClnRpc::new(&self.rpc_path)
            .await
            .map_err(|e| Status::new(Code::Internal, e.to_string()))?;
        let result = rpc.call(Request::DelInvoice(req)).await.map_err(|e| {
            Status::new(
                Code::Unknown,
        ...
        match result {
            ...
            r => Err(Status::new(
                Code::Internal,
                format!("Unexpected result {:?} to method call DelInvoice", r),
            )),
        }
    }
    ...
    async fn list_datastore(
        ...
        let mut rpc = ClnRpc::new(&self.rpc_path)
            .await
            .map_err(|e| Status::new(Code::Internal, e.to_string()))?;
        let result = rpc.call(Request::ListDatastore(req)).await.map_err(|e| {
            Status::new(
                Code::Unknown,
        ...
        match result {
            ...
            r => Err(Status::new(
                Code::Internal,
                format!("Unexpected result {:?} to method call ListDatastore", r),
            )),
        }
    }
    ...
    async fn list_invoices(
        ...
        let mut rpc = ClnRpc::new(&self.rpc_path)
            .await
            .map_err(|e| Status::new(Code::Internal, e.to_string()))?;
        let result = rpc.call(Request::ListInvoices(req)).await.map_err(|e| {
            Status::new(
                Code::Unknown,
        ...
        match result {
            ...
            r => Err(Status::new(
                Code::Internal,
                format!("Unexpected result {:?} to method call ListInvoices", r),
            )),
        }
    }
    ...
    async fn send_onion(
        ...
        let mut rpc = ClnRpc::new(&self.rpc_path)
            .await
            .map_err(|e| Status::new(Code::Internal, e.to_string()))?;
        let result = rpc.call(Request::SendOnion(req)).await.map_err(|e| {
            Status::new(
                Code::Unknown,
        ...
        match result {
            ...
            r => Err(Status::new(
                Code::Internal,
                format!("Unexpected result {:?} to method call SendOnion", r),
            )),
        }
    }
    ...
    async fn list_send_pays(
        ...
        let mut rpc = ClnRpc::new(&self.rpc_path)
            .await
            .map_err(|e| Status::new(Code::Internal, e.to_string()))?;
        let result = rpc.call(Request::ListSendPays(req)).await.map_err(|e| {
            Status::new(
                Code::Unknown,
        ...
        match result {
            ...
            r => Err(Status::new(
                Code::Internal,
                format!("Unexpected result {:?} to method call ListSendPays", r),
            )),
        }
    }
    ...
    async fn list_transactions(
        ...
        let mut rpc = ClnRpc::new(&self.rpc_path)
            ...
            .map_err(|e| Status::new(Code::Internal, e.to_string()))?;
        let result = rpc
            .call(Request::ListTransactions(req))
            .await
            .map_err(|e| {
                Status::new(
                    Code::Unknown,
        ...
        match result {
            ...
            r => Err(Status::new(
                Code::Internal,
                format!("Unexpected result {:?} to method call ListTransactions", r),
            )),
        }
    }
    ...
    async fn pay(
        ...
        let mut rpc = ClnRpc::new(&self.rpc_path)
            .await
            .map_err(|e| Status::new(Code::Internal, e.to_string()))?;
        let result = rpc.call(Request::Pay(req)).await.map_err(|e| {
            Status::new(Code::Unknown, format!("Error calling method Pay: {:?}", e))
        })?;
        match result {
            Response::Pay(r) => {
            ...
            r => Err(Status::new(
                Code::Internal,
                format!("Unexpected result {:?} to method call Pay", r),
            )),
        }
    }
    ...
    async fn list_nodes(
        ...
        let mut rpc = ClnRpc::new(&self.rpc_path)
            .await
            .map_err(|e| Status::new(Code::Internal, e.to_string()))?;
        let result = rpc.call(Request::ListNodes(req)).await.map_err(|e| {
            Status::new(
                Code::Unknown,
        ...
        match result {
            ...
            r => Err(Status::new(
                Code::Internal,
                format!("Unexpected result {:?} to method call ListNodes", r),
            )),
        }
    }
    ...
    async fn wait_any_invoice(
        ...
        let mut rpc = ClnRpc::new(&self.rpc_path)
            .await
            .map_err(|e| Status::new(Code::Internal, e.to_string()))?;
        let result = rpc.call(Request::WaitAnyInvoice(req)).await.map_err(|e| {
            Status::new(
                Code::Unknown,
        ...
        match result {
            ...
            r => Err(Status::new(
                Code::Internal,
                format!("Unexpected result {:?} to method call WaitAnyInvoice", r),
            )),
        }
    }
    ...
    async fn wait_invoice(
        ...
        let mut rpc = ClnRpc::new(&self.rpc_path)
            .await
            .map_err(|e| Status::new(Code::Internal, e.to_string()))?;
        let result = rpc.call(Request::WaitInvoice(req)).await.map_err(|e| {
            Status::new(
                Code::Unknown,
        ...
        match result {
            ...
            r => Err(Status::new(
                Code::Internal,
                format!("Unexpected result {:?} to method call WaitInvoice", r),
            )),
        }
    }
    ...
    async fn wait_send_pay(
        ...
        let mut rpc = ClnRpc::new(&self.rpc_path)
            .await
            .map_err(|e| Status::new(Code::Internal, e.to_string()))?;
        let result = rpc.call(Request::WaitSendPay(req)).await.map_err(|e| {
            Status::new(
                Code::Unknown,
        ...
        match result {
            ...
            r => Err(Status::new(
                Code::Internal,
                format!("Unexpected result {:?} to method call WaitSendPay", r),
            )),
        }
    }
    ...
    async fn new_addr(
        ...
        let mut rpc = ClnRpc::new(&self.rpc_path)
            .await
            .map_err(|e| Status::new(Code::Internal, e.to_string()))?;
        let result = rpc.call(Request::NewAddr(req)).await.map_err(|e| {
            Status::new(
                Code::Unknown,
        ...
        match result {
            ...
            r => Err(Status::new(
                Code::Internal,
                format!("Unexpected result {:?} to method call NewAddr", r),
            )),
        }
    }
    ...
    async fn withdraw(
        ...
        let mut rpc = ClnRpc::new(&self.rpc_path)
            .await
            .map_err(|e| Status::new(Code::Internal, e.to_string()))?;
        let result = rpc.call(Request::Withdraw(req)).await.map_err(|e| {
            Status::new(
                Code::Unknown,
        ...
        match result {
            ...
            r => Err(Status::new(
                Code::Internal,
                format!("Unexpected result {:?} to method call Withdraw", r),
            )),
        }
    }
    ...
    async fn key_send(
        ...
        let mut rpc = ClnRpc::new(&self.rpc_path)
            .await
            .map_err(|e| Status::new(Code::Internal, e.to_string()))?;
        let result = rpc.call(Request::KeySend(req)).await.map_err(|e| {
            Status::new(
                Code::Unknown,
        ...
        match result {
            ...
            r => Err(Status::new(
                Code::Internal,
                format!("Unexpected result {:?} to method call KeySend", r),
            )),
        }
    }
    ...
    async fn fund_psbt(
        ...
        let mut rpc = ClnRpc::new(&self.rpc_path)
            .await
            .map_err(|e| Status::new(Code::Internal, e.to_string()))?;
        let result = rpc.call(Request::FundPsbt(req)).await.map_err(|e| {
            Status::new(
                Code::Unknown,
        ...
        match result {
            ...
            r => Err(Status::new(
                Code::Internal,
                format!("Unexpected result {:?} to method call FundPsbt", r),
            )),
        }
    }
    ...
    async fn send_psbt(
        ...
        let mut rpc = ClnRpc::new(&self.rpc_path)
            .await
            .map_err(|e| Status::new(Code::Internal, e.to_string()))?;
        let result = rpc.call(Request::SendPsbt(req)).await.map_err(|e| {
            Status::new(
                Code::Unknown,
        ...
        match result {
            ...
            r => Err(Status::new(
                Code::Internal,
                format!("Unexpected result {:?} to method call SendPsbt", r),
            )),
        }
    }
    ...
    async fn sign_psbt(
        ...
        let mut rpc = ClnRpc::new(&self.rpc_path)
            .await
            .map_err(|e| Status::new(Code::Internal, e.to_string()))?;
        let result = rpc.call(Request::SignPsbt(req)).await.map_err(|e| {
            Status::new(
                Code::Unknown,
        ...
        match result {
            ...
            r => Err(Status::new(
                Code::Internal,
                format!("Unexpected result {:?} to method call SignPsbt", r),
            )),
        }
    }
    ...
    async fn utxo_psbt(
        ...
        let mut rpc = ClnRpc::new(&self.rpc_path)
            .await
            .map_err(|e| Status::new(Code::Internal, e.to_string()))?;
        let result = rpc.call(Request::UtxoPsbt(req)).await.map_err(|e| {
            Status::new(
                Code::Unknown,
        ...
        match result {
            ...
            r => Err(Status::new(
                Code::Internal,
                format!("Unexpected result {:?} to method call UtxoPsbt", r),
            )),
        }
    }
    ...
    async fn tx_discard(
        ...
        let mut rpc = ClnRpc::new(&self.rpc_path)
            .await
            .map_err(|e| Status::new(Code::Internal, e.to_string()))?;
        let result = rpc.call(Request::TxDiscard(req)).await.map_err(|e| {
            Status::new(
                Code::Unknown,
        ...
        match result {
            ...
            r => Err(Status::new(
                Code::Internal,
                format!("Unexpected result {:?} to method call TxDiscard", r),
            )),
        }
    }
    ...
    async fn tx_prepare(
        ...
        let mut rpc = ClnRpc::new(&self.rpc_path)
            .await
            .map_err(|e| Status::new(Code::Internal, e.to_string()))?;
        let result = rpc.call(Request::TxPrepare(req)).await.map_err(|e| {
            Status::new(
                Code::Unknown,
        ...
        match result {
            ...
            r => Err(Status::new(
                Code::Internal,
                format!("Unexpected result {:?} to method call TxPrepare", r),
            )),
        }
    }
    ...
    async fn tx_send(
        ...
        let mut rpc = ClnRpc::new(&self.rpc_path)
            .await
            .map_err(|e| Status::new(Code::Internal, e.to_string()))?;
        let result = rpc.call(Request::TxSend(req)).await.map_err(|e| {
            Status::new(
                Code::Unknown,
        ...
        match result {
            ...
            r => Err(Status::new(
                Code::Internal,
                format!("Unexpected result {:?} to method call TxSend", r),
            )),
        }
    }
    ...
    async fn disconnect(
        ...
        let mut rpc = ClnRpc::new(&self.rpc_path)
            .await
            .map_err(|e| Status::new(Code::Internal, e.to_string()))?;
        let result = rpc.call(Request::Disconnect(req)).await.map_err(|e| {
            Status::new(
                Code::Unknown,
        ...
        match result {
            ...
            r => Err(Status::new(
                Code::Internal,
                format!("Unexpected result {:?} to method call Disconnect", r),
            )),
        }
    }
    ...
    async fn feerates(
        ...
        let mut rpc = ClnRpc::new(&self.rpc_path)
            .await
            .map_err(|e| Status::new(Code::Internal, e.to_string()))?;
        let result = rpc.call(Request::Feerates(req)).await.map_err(|e| {
            Status::new(
                Code::Unknown,
        ...
        match result {
            ...
            r => Err(Status::new(
                Code::Internal,
                format!("Unexpected result {:?} to method call Feerates", r),
            )),
        }
    }
    ...
    async fn fund_channel(
        ...
        let mut rpc = ClnRpc::new(&self.rpc_path)
            .await
            .map_err(|e| Status::new(Code::Internal, e.to_string()))?;
        let result = rpc.call(Request::FundChannel(req)).await.map_err(|e| {
            Status::new(
                Code::Unknown,
        ...
        match result {
            ...
            r => Err(Status::new(
                Code::Internal,
                format!("Unexpected result {:?} to method call FundChannel", r),
            )),
        }
    }
    ...
    async fn get_route(
        ...
        let mut rpc = ClnRpc::new(&self.rpc_path)
            .await
            .map_err(|e| Status::new(Code::Internal, e.to_string()))?;
        let result = rpc.call(Request::GetRoute(req)).await.map_err(|e| {
            Status::new(
                Code::Unknown,
        ...
        match result {
            ...
            r => Err(Status::new(
                Code::Internal,
                format!("Unexpected result {:?} to method call GetRoute", r),
            )),
        }
    }
    ...
    async fn list_forwards(
        ...
        let mut rpc = ClnRpc::new(&self.rpc_path)
            .await
            .map_err(|e| Status::new(Code::Internal, e.to_string()))?;
        let result = rpc.call(Request::ListForwards(req)).await.map_err(|e| {
            Status::new(
                Code::Unknown,
        ...
        match result {
            ...
            r => Err(Status::new(
                Code::Internal,
                format!("Unexpected result {:?} to method call ListForwards", r),
            )),
        }
    }
    ...
    async fn list_pays(
        ...
        let mut rpc = ClnRpc::new(&self.rpc_path)
            .await
            .map_err(|e| Status::new(Code::Internal, e.to_string()))?;
        let result = rpc.call(Request::ListPays(req)).await.map_err(|e| {
            Status::new(
                Code::Unknown,
        ...
        match result {
            ...
            r => Err(Status::new(
                Code::Internal,
                format!("Unexpected result {:?} to method call ListPays", r),
            )),
        }
    }
    ...
    async fn ping(
        ...
        let mut rpc = ClnRpc::new(&self.rpc_path)
            .await
            .map_err(|e| Status::new(Code::Internal, e.to_string()))?;
        let result = rpc.call(Request::Ping(req)).await.map_err(|e| {
            Status::new(Code::Unknown, format!("Error calling method Ping: {:?}", e))
        })?;
        match result {
            Response::Ping(r) => {
            ...
            r => Err(Status::new(
                Code::Internal,
                format!("Unexpected result {:?} to method call Ping", r),
            )),
        }
    }
    ...
    async fn send_custom_msg(
        ...
        let mut rpc = ClnRpc::new(&self.rpc_path)
            .await
            .map_err(|e| Status::new(Code::Internal, e.to_string()))?;
        let result = rpc.call(Request::SendCustomMsg(req)).await.map_err(|e| {
            Status::new(
                Code::Unknown,
        ...
        match result {
            ...
            r => Err(Status::new(
                Code::Internal,
                format!("Unexpected result {:?} to method call SendCustomMsg", r),
            )),
        }
    }
    ...
    async fn set_channel(
        ...
        let mut rpc = ClnRpc::new(&self.rpc_path)
            .await
            .map_err(|e| Status::new(Code::Internal, e.to_string()))?;
        let result = rpc.call(Request::SetChannel(req)).await.map_err(|e| {
            Status::new(
                Code::Unknown,
        ...
        match result {
            ...
            r => Err(Status::new(
                Code::Internal,
                format!("Unexpected result {:?} to method call SetChannel", r),
            )),
        }
    }
    ...
    async fn sign_invoice(
        ...
        let mut rpc = ClnRpc::new(&self.rpc_path)
            .await
            .map_err(|e| Status::new(Code::Internal, e.to_string()))?;
        let result = rpc.call(Request::SignInvoice(req)).await.map_err(|e| {
            Status::new(
                Code::Unknown,
        ...
        match result {
            ...
            r => Err(Status::new(
                Code::Internal,
                format!("Unexpected result {:?} to method call SignInvoice", r),
            )),
        }
    }
    ...
    async fn sign_message(
        ...
        let mut rpc = ClnRpc::new(&self.rpc_path)
            .await
            .map_err(|e| Status::new(Code::Internal, e.to_string()))?;
        let result = rpc.call(Request::SignMessage(req)).await.map_err(|e| {
            Status::new(
                Code::Unknown,
        ...
        match result {
            ...
            r => Err(Status::new(
                Code::Internal,
                format!("Unexpected result {:?} to method call SignMessage", r),
            )),
        }
    }
    ...
    async fn stop(
        ...
        let mut rpc = ClnRpc::new(&self.rpc_path)
            .await
            .map_err(|e| Status::new(Code::Internal, e.to_string()))?;
        let result = rpc.call(Request::Stop(req)).await.map_err(|e| {
            Status::new(Code::Unknown, format!("Error calling method Stop: {:?}", e))
        })?;
        match result {
            Response::Stop(r) => {
            ...
            r => Err(Status::new(
                Code::Internal,
                format!("Unexpected result {:?} to method call Stop", r),
            )),
        }
    }
}
